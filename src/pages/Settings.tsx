...
const Settings = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col gap-6 items-center py-10">
          ...
          <div className="divide-y divide-gray-200">
            <div className="py-4 flex justify-between items-center">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute bottom-0 right-[-2px] bg-white rounded-full p-1.5 hover:bg-gray-200 focus:outline-none cursor-pointer"
            ...
            <div className="py-4 flex justify-between items-center">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button className="rounded-full p-2 hover:bg-gray-200 focus:outline-none cursor-pointer">
                  <FiEdit />
                </button>
              </div>
            </div>
            ...
            <div className="py-4 flex justify-between items-center">
              <span className="flex flex-col gap-2">
                ...
                <p className="text-gray-500 text-sm max-w-sm">
                  This feature allows us to use your search data to improve our
